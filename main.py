...
# Function to recognize speech and format symptoms
...
def recognize_symptoms():
    ...
    try:
        ...
        # Ensure words are separated by commas
        formatted_symptoms = ", ".join(recognized_text.lower().split())

        print("Recognized Symptoms:", formatted_symptoms)  # Debugging
...
# Disease.sh API URL
API_URL = "https://disease.sh/v3/covid-19/diseaseInfo"
...
def search():
    ...
    response = requests.get(f"https://disease.sh/v3/covid-19/diseaseInfo/{query}")
